...
import 'package:zxing_example/decode.dart';
          ...
          return ClipRect(
            child: OverflowBox(
                ...
                child: FittedBox(
                  fit: BoxFit.fitWidth,
                  child: Container(
                      width: layout.biggest.width,
                      height:
                          layout.biggest.width / controller.value.aspectRatio,
                      child: AspectRatio(
  ...
  void onNewCameraSelected(CameraDescription cameraDescription) async {
    ...
    try {
      ...
      await controller.startImageStream((image) async {
        ...
        var result = decode(image);
        if (result != null) {
          print('Elapsed ${stopWatch.elapsedMilliseconds}ms');
          print('Result ${result.text}');
          print(
              'image ${image.width}x${image.height} ${image.planes.first.bytes.length}');
        }
      });
